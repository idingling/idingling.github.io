 ...
 * $Id: feedback.inc.php 960 2016-02-09 17:29:08Z zhuge $
...
require_once ('pluginvar.func.php');//14631
...
$param = 'data='.rawurlencode(base64_encode($data));//版权：1314学习网，未经允许不得公开出售、发布、使用、修改，如需购买请联系我们获得授权
