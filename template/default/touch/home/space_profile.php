...
<div class="userinfo">
	...
	<div class="user_box" style="margin-top:10px;">
		<ul>
			<li><a href="home.php?mod=space&do=pm">{lang viewmypm}</a></li>
			<li><a href="forum.php?mod=guide&view=my">{lang my_posts}</a></li>
			<li><a href="home.php?mod=space&do=favorite&view=me">{lang myfavorite}</a></li>
