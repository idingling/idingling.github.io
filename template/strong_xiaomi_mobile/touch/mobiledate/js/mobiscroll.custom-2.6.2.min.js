(function(a) {
    function m(f, c) {
        ...
        function r(c) {
            ...
            b;
            x ? (a.each(["t", "webkitT", "MozT", "OT", "msT"], 
            function(a, c) {
                if (void 0 !== g[c + "ransform"]) return b = g[c + "ransform"],
                !1
        ...
        function K(c, g, b, k, y) { ! 1 !== E("validate", [v, g, c]) && (a(".dw-ul", v).each(function(b) {
                var h = a(this),
                ...
                I = b == g || void 0 === g;
                if (!e.hasClass("dw-v")) {
                    for (var o = e, d = 0, l = 0; 0 <= f - d && !o.hasClass("dw-v");) d++,
                    o = i.eq(f - d);
                    for (; f + l < 
                    j && !e.hasClass("dw-v");) l++,
                    e = i.eq(f + l); (l < d && l && 2 !== k || !d || 0 > f - d || 1 == k) && e.hasClass("dw-v") ? f += l: (e = o, f -= d)
                }
                if (!e.hasClass("dw-sel") || I) n.temp[b] = e.attr("data-val"),
                a(".dw-sel", h).removeClass("dw-sel"),
                p.multiple || (a(".dw-sel", h).removeAttr("aria-selected"), e.attr("aria-selected", "true")),
                e.addClass("dw-sel"),
                m(h, b, f, I ? c: 0.1, I ? y: !1)
            }), R = p.formatResult(n.temp), "inline" == p.display ? ia(b, 0, !0) : a(".dwv", v).html(d(R)), b && E("onChange", [R]))
        }
        function E(g, b) {
            var k;
            b.push(n);
            a.each([ka.defaults, qa, c], 
            function(a, 
            c) {
                c[g] && (k = c[g].apply(N, b))
            });
        ...
        n.changeWheel = function(c, g) {
            if (v) {
                ...
                function(e, h) {
                    a.each(h, 
                    function(e, h) {
                        if ( - 1 < a.inArray(b, c) && (la[b] = h, a(".dw-ul", v).eq(b).html(y(b)), k--, !k)) return n.position(),
                        K(g, void 0, !0),
                        !1;
                        b++
                    });
        ...
        n.show = function(c) {
            ...
            ka.init(v, n);
            if ("inline" != p.display) {
                n.tap(a(".dwb-s span", v), 
                function() {
                    n.select()
                });
                n.tap(a(".dwb-c span", v), 
                function() {
                    n.cancel()
                });
                ...
                if (p.scrollLock) v.on("touchmove touchstart", 
                function(a) {
                    sa && a.preventDefault()
                });
                ...
                function(a) {
                    ...
                    za = setTimeout(function() {
                        var c = a.type == "scroll"; (c && sa || !c) && n.position(!c)
                    },
                    100)
                });
                n.alert(p.ariaDesc)
            ...
            v.on(C, ".dwb-e", Ga).on("keydown", ".dwb-e", 
            function(c) {
                if (c.keyCode == 32) {
                    c.preventDefault();
                    c.stopPropagation();
        ...
        n.select = function() { ! 1 !== n.hide(!1, "set") && (ia(!0, 0, !0), E("onSelect", [n.val]))
        };
        n.alert = function(a) {
            o.text(a);
            clearTimeout(s);
        ...
        n.cancel = function() { ! 1 !== n.hide(!1, "cancel") && E("onCancel", [n.val])
        };
        n.init = function(a) {
            ka = i({
                defaults: {},
            ...
            n.settings = p;
            G.off(".dw");
            if (a = wa.presets[p.preset]) qa = a.call(N, n),
            i(p, qa, c);
            ...
            if ("inline" == p.display) n.show();
                ...
                l();
                if (aa && (void 0 === ua && (ua = N.readOnly), N.readOnly = !0, p.showOnFocus)) G.on("focus.dw", 
                function() {
                    va || n.show();
                    va = false
                });
    ...
    function l(a, c, b) {
        ...
        "string" === typeof c && a.each(function() {
            var a;
            if ((a = q[this.id]) && a[c]) if (a = a[c].apply(this, Array.prototype.slice.call(b, 1)), void 0 !== a) return k = a,
            !1
        });
        return k
    }
    ...
    A = function(d) {
        ...
        if (J.match(/date/i)) {
            ...
            for (o = 0; 3 > o; o++) if (o == w.y) {
                ...
                A = K.getFullYear();
                D = E.getFullYear();
                for (b = A; b <= D; b++) r.push(b),
                x.push(c.match(/yy/i) ? b: (b + "").substr(2, 2));
                e(q, r, x, i.yearText)
            } else if (o == w.m) {
                C++;
                x = [];
                ...
                r.push(b),
                x.push(A.match(/MM/) ? A.replace(/MM/, '<span class="dw-mon">' + i.monthNames[b] + "</span>") : A.replace(/M/, '<span class="dw-mon">' + i.monthNamesShort[b] + "</span>"));
                e(q, r, x, i.monthText)
            } else if (o == w.d) {
                C++;
                x = [];
                r = [];
                for (b = 1; 32 > b; b++) r.push(b),
                x.push(c.match(/dd/i) && 10 > b ? "0" + b: b);
                e(q, r, x, i.dayText)
            }
            s.push(q)
        }
        if (J.match(/time/i)) {
            ...
            for (o = C; o < C + 4; o++) if (o == w.h) {
                ...
                x = [];
                r = [];
                for (b = 0; b < (h ? 12: 24); b += da) r.push(b),
                x.push(h && 0 == b ? 12: g.match(/hh/i) && 10 > b ? "0" + b: b);
                e(q, r, x, i.hourText)
            } else if (o == w.i) {
                C++;
                x = [];
                r = [];
                for (b = 0; 60 > b; b += oa) r.push(b),
                x.push(g.match(/ii/) && 10 > b ? "0" + b: b);
                e(q, r, x, i.minuteText)
            } else if (o == w.s) {
                C++;
                x = [];
                r = [];
                for (b = 0; 60 > b; b += pa) r.push(b),
                x.push(g.match(/ss/) && 10 > b ? "0" + b: b);
                e(q, r, x, i.secText)
            ...
            validate: function(b) {
                ...
                function(h, d) {
                    if (w[d] !== void 0) {
                        ...
                        if (i.invalid && d == "d") {
                            var m = [];
                            i.invalid.dates && a.each(i.invalid.dates, 
                            function(a, c) {
                            ...
                            if (i.invalid.daysOfWeek) {
                                ...
                                F;
                                a.each(i.invalid.daysOfWeek, 
                                function(a, c) {
                                    for (F = c - da; F < $; F = F + 7) F >= 0 && m.push(F)
                                })
                            }
                            i.invalid.daysOfMonth && a.each(i.invalid.daysOfMonth, 
                            function(a, c) {
                                c = (c + "").split("/");
    ...
    m.formatDate = function(d, l, e) {
        ...
        z, e),
        j = function(a) {
            for (var b = 0; o + 1 < d.length && d.charAt(o + 1) == a;) b++,
            o++;
            return b
        },
        t = function(a, b, d) {
        ...
        f = "",
        q = !1;
        for (o = 0; o < d.length; o++) if (q)"'" == d.charAt(o) && !j("'") ? q = !1: f += d.charAt(o);
    ...
    m.parseDate = function(d, l, e) {
        ...
        m = -1,
        A = !1,
        D = function(a) { (a = w + 1 < d.length && d.charAt(w + 1) == a) && w++;
            return a
        },
        i = function(a) {
            D(a);
        ...
        C = function(a, b, c) {
            a = D(a) ? c: b;
            for (b = 0; b < a.length; b++) if (l.substr(u, a[b].length).toLowerCase() == a[b].toLowerCase()) return u += a[b].length,
            b + 1;
            return 0
        },
        u = 0,
        w;
        for (w = 0; w < d.length; w++) if (A)"'" == d.charAt(w) && !D("'") ? A = !1: u++;
    ...
    z = function(m) {
        ...
        function l(a, b, k) {
            ...
            for (d = 0; d < k.length;) k[d].invalid && e.push(k[d].key),
            d++;
            return e
        }
        function e(a, b) {
        ...
        function j(a, b, k) {
            ...
            for (; d < a.length;) {
                ...
                l = 0; l < j.length;) m.values.push(j[l].value),
                m.keys.push(j[l].key),
                l++;
                h[b] = [m];
                h = 0;
                ...
                if (void 0 !== b && i[b].children) d++,
                i = i[b].children;
                else if ((e = t(i)) && e.children) d++,
                i = e.children;
                else break
            }
            return f
        ...
        function o(a, b) {
            ...
            if (void 0 !== a[h] && h <= b) {
                f = 0;
                i = a[h];
                for (j = void 0; f < e.length && void 0 === j;) e[f].key == a[h] && !e[f].invalid && (j = f),
                f++
            } else j = t(e, !0),
            i = e[j].key;
        ...
        return {
            ...
            onShow: function(c) {
                a(".dwwl", c).on("mousedown touchstart", 
                function() {
    ...
    a.mobiscroll.presets.select = function(d) {
        ...
        function A(a, e) {
            ...
            if (t) {
                var l = [],
                h = 0;
                for (h in d._selectedValues) l.push(i[h]),
                f.push(h);
                B.val(l.join(", "))
            } else B.val(a),
            f = e ? d.values[u] : null;
        ...
        B,
        J = e.readonly;
        e.group && !a("optgroup", j).length && (e.group = 
        !1);
        ...
        return {
            ...
            onMarkupReady: function(b) {
                a(".dwwl" + C, b).on("mousedown touchstart", 
                function() {
                    clearTimeout(w)
                });
                if (t) {
    ...
    a.mobiscroll.themes.wp = {
        ...
        init: function(d, z) {
            ...
            a(".dwwl", d).on("touchstart mousedown DOMMouseScroll mousewheel", ".dw-sel", 
            function() {
                A = !0;
