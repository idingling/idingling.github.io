  ...
  <div id="topbar" class="cl"> 
    ...
    <div class="wp"> 
      ...
      <div class="userbox"> 
        <!--{if $_G['uid']}-->
        <ul class="usernav">
          <li class="user_list" style="margin: 0 0 0 15px;"><a id="nte_menu" href="home.php?mod=space&do=notice" class="user_link notification">提醒<!--{if $_G[member][newprompt]}--><span class="unread_num png">$_G[member][newprompt]</span><!--{/if}--></a> </li>
          <li class="user_list msg"> <a id="msg_menu" href="home.php?mod=space&do=pm" class="user_link msg">消息<!--{if $_G[member][newpm]}--><span class="unread_num png">{$_G[member][newpm]}</span><!--{/if}--></a> </li>
        </ul>
        <div style="float: left;"> <a href="home.php?mod=space&uid=$_G[uid]" title="{$_G[member][username]}" class="userinfo" id="m" onMouseOver="showMenu({'ctrlid':'m','pos':'34!','ctrlclass':'hover','duration':2});"> <span class="user_avt">{$_G[member][username]}</span><i class="arrow"></i></a> </div>
        ...
        <ul class="usernav user_part">
          <a href="javascript:;" class="user_login" id="l" onMouseOver="showMenu({'ctrlid':'l','ctrlclass':'hover','duration':2});" onClick="javascript:lsSubmit();">{lang login}</a>
          <a class="user_login" style="padding: 1px 0 0 0; margin: 0;">|</a>
          <a href="member.php?mod={$_G[setting][regname]}" class="user_login" style="margin: 0;">注册</a>
        </ul>
