...
<!--{/if}-->
<script type="text/javascript" src="$_G['style'][styleimgdir]/js/forum_viewthread.js?{VERHASH}"></script>
...
<div id="ct" class="wp cl" style="margin: 25px 0 0 0;">
		...
		<div class="forum-right">
          <div class="thread_post cl">
             <a id="thread_post" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=$_G[fid]')" href="javascript:;" title="发新帖"><img src="template/time_9th_keji/src/thread_post.png" alt="发新帖"></a>
          </div>
          <div id="sd_bdr">           
            <div class="drag"> 
              <!--[diy=forum-bar]-->
          ...
          <div class="view-hot">
            <div class="bd">
               <!--[diy=view_hot]--><div id="view_hot" class="area"></div><!--[/diy]-->          
            </div>
          </div>
		...
		<tr>
            ...
            <div class="cl">
				...
				<!--{if $_G['setting']['close_leftinfo_userctrl']}-->
					...
					<!--{if !$close_leftinfo}-->
						<a onclick="setcookie('close_leftinfo', 1);location.reload();" title="{lang collapse_the_left}" class="btn_s_close" href="javascript:;"><img src="$_G['style'][styleimgdir]/control_l.png" alt="{lang collapse_the_left}" class="vm" /></a>
					<!--{else}-->
						<a onclick="setcookie('close_leftinfo', 2);location.reload();" title="{lang open_the_left}" class="btn_s_open" href="javascript:;"><img src="$_G['style'][styleimgdir]/control_r.png" alt="{lang open_the_left}" class="vm" /></a>
					<!--{/if}-->
					</span>
				<!--{/if}-->
				...
				<h1 class="ts f18">
					<!--{if $_G['forum_thread']['typeid'] && $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']]}-->
						<!--{if !IS_ROBOT && ($_G['forum']['threadtypes']['listable'] || $_G['forum']['status'] == 3)}-->
							<a href="forum.php?mod=forumdisplay&fid=$_G[fid]&filter=typeid&typeid=$_G[forum_thread][typeid]" class="forum_type">{$_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']]} --- </a>
						<!--{else}-->
