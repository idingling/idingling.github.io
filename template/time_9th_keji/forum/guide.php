	...
	<div id="ct" class="wp cl{if $_G['forum']['allowside']} ct2{/if}"{if $leftside} style="margin-left:{$_G['leftsidewidth_mwidth']}px"{/if}>
		<div class="mn">
			...
			<div id="pgt" class="bm bw0 pgs cl">
				$multipage
				<a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav" style="display: block; float: left; background: #555555;"><img src="$_G['style'][styleimgdir]/pn_post.png" alt="{lang send_posts}" /></a>
			</div>
			<!--{/if}-->
